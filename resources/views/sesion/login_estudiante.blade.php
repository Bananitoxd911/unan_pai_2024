    ...
    <div class="min-h-screen flex flex-col items-center justify-center">
        ...
        <div class="md:max-w-md w-full px-4 py-4">
            ...
            <div class="mt-8">
                ...
                <div class="relative flex items-center">
                <input name="pin" type="password" required class="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Ingrese su PIN" />
                </div>
            </div>
